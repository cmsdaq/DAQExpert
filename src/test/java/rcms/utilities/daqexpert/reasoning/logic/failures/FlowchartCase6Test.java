...
public class FlowchartCase6Test extends FlowchartCaseTestBase {
	...
	/** test to ensure that the subsystem which stopped sending fragments
	...
	public void case2Test() throws URISyntaxException {
		...
		assertEquals(new HashSet<>(Arrays.asList("PIXEL")),
						fc6.getContext().getContext().get("FROZENSUBSYSTEM")
						);
