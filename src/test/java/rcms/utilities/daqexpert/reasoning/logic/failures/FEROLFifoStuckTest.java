...
/**
 * Tests for class FEROLFifoStuckTest . Note that some of the test
 * cases are very close in time and thus may actually be the same
 * problem after starting/stopping etc.
 * 
 */
public class FEROLFifoStuckTest extends FlowchartCaseTestBase {
	...
	private void test(String snapshotFile) throws URISyntaxException {
		...
		assertEquals(new HashSet<>(Arrays.asList("http://frlpc40-s2d19-40-01.cms:11100/urn:xdaq-application:lid=111/expertDebugPage")),
						fullURLs);
