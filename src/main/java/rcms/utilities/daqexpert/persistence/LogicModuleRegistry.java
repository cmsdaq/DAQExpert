...
public enum LogicModuleRegistry {
	...
	LinkProblem				(new LinkProblem(),				 ConditionGroup.FLOWCHART,             "",                                                   36, 10010),
	RuStuckWaiting			(new RuStuckWaiting(),			 ConditionGroup.FLOWCHART,             "",                                                   37, 10011),
	RuStuck					(new RuStuck(),					 ConditionGroup.FLOWCHART,             "",                                                   38, 10012),
