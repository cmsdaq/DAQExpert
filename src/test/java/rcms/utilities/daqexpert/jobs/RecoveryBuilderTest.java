...
public class RecoveryBuilderTest {
    ...
    public void test(){
        ...
        List<List<Pair<Jobs,String>>> jobs = recoveryBuilder.getJobs(steps);
        ...
        Assert.assertEquals("ECAL", jobs.iterator().next().iterator().next().getRight());
    ...
    public void manyStepsTest(){
        ...
        Assert.assertEquals("TRACKER", jobs.iterator().next().iterator().next().getRight());
    }
